...
import { Accordion, BodyLong, BodyShort, Button, Label, Loader, Spacer } from '@navikt/ds-react'
...
import { ShowWarningMessage } from '../../../../../kravCard/kravCard'
import EndretInfo from '../../../../../tilbakemeldingEditInfo/tilbakemeldingsEditInfo'
import TilbakemeldingResponseMelding from '../../../../../tilbakemeldingResponseMelding/tilbakemeldingResponseMelding'
import TilbakemeldingSvar from '../../../../../tilbakemeldingSvar/tilbakemeldingSvar'
  ...
  return (
    <Suspense>
      <div className='w-full py-5'>
          ...
          <div className='flex flex-col'>
            <Accordion>
              {tilbakemeldinger.slice(0, count).map((tilbakemelding: ITilbakemelding) => {
                ...
                const { status, ubesvartOgKraveier, melderOrKraveier } =
                  getMelderInfo(tilbakemelding)
        ...
        <KravTilbakemeldingKravValid
          krav={krav}
          alleKravVersjoner={alleKravVersjoner}
          addTilbakemelding={addTilbakemelding}
          setAddTilbakemelding={setAddTilbakemelding}
          add={add}
        />
      </div>
    </Suspense>
