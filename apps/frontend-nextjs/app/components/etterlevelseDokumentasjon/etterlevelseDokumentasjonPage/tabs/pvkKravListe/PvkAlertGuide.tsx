...
const PvkAlertGuide: FunctionComponent<TProps> = ({ pvkDokument, etterlevelseDokumentasjon }) => (
  <Fragment>
    {pvkDokument && pvkDokument.status === EPvkDokumentStatus.UNDERARBEID && (
      <InfoCard data-color='info' className='max-w-[75ch]'>
        ...
        <InfoCard.Content>
          ...
          <BodyLong>
            Dere kan gjenbruke deres egne risikoscenarioer og tiltak der det er aktuelt. Dette gjør
            dere ved å velge “Legg til et eksisterende risikoscenario” eller “Legg til et
            eksisterende tiltak”.
          </BodyLong>
        </InfoCard.Content>
      </InfoCard>
      ...
      <InfoCard data-color='warning' className='max-w-[75ch]'>
        ...
        <InfoCard.Content>
          ...
          <List as='ul' className='mb-5'>
            ...
            <List.Item>risikoscenarioer og tiltak, både kravspesifikke og øvrige</List.Item>
            <List.Item>
              PVK-dokumentasjon ellers: Behandlings livsløp, Art og omfang, Involvering av eksterne,
              kommentar til personvernombudet
            </List.Item>
          </List>
          <BodyLong>
            Etterlevelsesdokumentasjon som ikke er tilknyttet PVK kan fortsatt redigeres som
