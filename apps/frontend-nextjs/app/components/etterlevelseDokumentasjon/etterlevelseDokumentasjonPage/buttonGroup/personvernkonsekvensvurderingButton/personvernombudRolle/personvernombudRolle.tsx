...
import {
  EtterleverVariantEight,
  EtterleverVariantEleven,
  EtterleverVariantNine,
  EtterleverVariantTen,
...
const PersonvernombudRolle: FunctionComponent = (
  ...
  switch (test) {
    ...
    case EPVKTilstandStatus.ETTERLEVER_HAR_BEGYNT_MED_NYE_ENDRINGER_TELLES_SOM_UNDER_ARBEID:
      return <EtterleverVariantEleven />
