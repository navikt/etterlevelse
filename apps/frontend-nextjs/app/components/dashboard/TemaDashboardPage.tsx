      ...
      >
        <List>
          <List.Item>
            ...
            eksempel er smidig produktutvikling, hvor nytt utviklingsarbeid kan tvinge en
            revurdering av hvordan man etterlever enkelte krav.
          </List.Item>
          <List.Item>
          ...
          <List.Item>
            ...
            <br />
            Det er begrenset med hvor mange irrelevante etterlevelseskrav man får filtrert bort før
            en begynner å dokumentere etterlevelse. Dette gjør at etterleveren selv kan være nødt
            til å markere noen krav og suksesskriterier som “ikke relevant”
          </List.Item>
          <List.Item>
            <b>
            ...
            registrert at de ble ferdig med vurderingen sin. Den tredje viser statistikk for krav
            som ikke ennå er registrert som ferdig vurdert, selv om etterleveren kan ha vurdert
            hvorvidt enkelte suksesskriterier etterleves.
          </List.Item>
        </List>
