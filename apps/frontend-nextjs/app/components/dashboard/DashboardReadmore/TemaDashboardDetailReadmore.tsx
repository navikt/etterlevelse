...
export const TemaDashboardDetailReadmore = () => (
    ...
    >
      <List>
        ...
        <List.Item>
          ...
          <br />
          Tallene over gjelder kun for aktive etterlevelseskrav. Statistikk om enkelte utgåtte
          etterlevelseskrav finner du nederst på denne siden, etter aktive krav.
        </List.Item>
      </List>
