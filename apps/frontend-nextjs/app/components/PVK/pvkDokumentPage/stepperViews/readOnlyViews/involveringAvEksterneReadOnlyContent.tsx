...
const InvolveringAvEksterneReadOnlyContent: FunctionComponent<TProps> = ({
  personkategorier,
  databehandlere,
  pvkDokument,
    ...
    <div className='flex justify-center'>
      <div>
        ...
        <List className='mt-10'>
          ...
          <BodyLong>I Behandlingskatalogen står det at følgende databehandlere benyttes:</BodyLong>
