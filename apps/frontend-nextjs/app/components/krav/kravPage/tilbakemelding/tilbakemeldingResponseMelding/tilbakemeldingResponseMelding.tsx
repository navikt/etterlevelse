...
import MeldingKnapper from '../edit/tilbakemeldingKnapper'
...
const TilbakemeldingResponseMelding: FunctionComponent<TProps> = (props) => {
  const { melding, tilbakemelding, oppdater, remove } = props

  const kraveier: boolean = melding.rolle === ETilbakemeldingRolle.KRAVEIER
  const sisteMelding =
      ...
      <ContentLayout>
        ...
        <div className='flex flex-col w-full ml-2.5'>
          <div className='flex items-center w-full'>
            <Label>{<PersonNavn ident={melding.fraIdent} kraveier={kraveier} />}</Label>
...
export default TilbakemeldingResponseMelding
