...
export enum EPVKTilstandStatus {
  IKKE_VURDERT_BEHOV_FOR_PVK = 'IKKE_VURDERT_BEHOV_FOR_PVK',
  SKAL_IKKE_GJORE_PVK = 'SKAL_IKKE_GJORE_PVK',
  SKAL_GJORE_PVK_MEN_IKKE_PABEGYNT = 'SKAL_GJORE_PVK_MEN_IKKE_PABEGYNT',
  PVK_UNDER_ARBEID_FOR_FORSTE_GANG_FOR_INNSENDING = 'PVK_UNDER_ARBEID_FOR_FORSTE_GANG_FOR_INNSENDING',
  PVK_SENDT_TIL_PVO_TELLES_SOM_UNDERARBEID = 'PVK_SENDT_TIL_PVO_TELLES_SOM_UNDERARBEID',
  PVO_HAR_GITT_TILBAKEMELDING_ETTERLEVER_KAN_REDIGERE_TELLES_SOM_UNDER_ARBEID = 'PVO_HAR_GITT_TILBAKEMELDING_ETTERLEVER_KAN_REDIGERE_TELLES_SOM_UNDER_ARBEID',
  ETTERLEVER_HAR_SENDT_TILBAKE_TIL_PVO_TELLES_SOM_UNDER_ARBEID = 'ETTERLEVER_HAR_SENDT_TILBAKE_TIL_PVO_TELLES_SOM_UNDER_ARBEID',
  ETTERLEVER_HAR_SENDT_TIL_RISIKOEIER_TELLES_SOM_UNDER_ARBEID = 'ETTERLEVER_HAR_SENDT_TIL_RISIKOEIER_TELLES_SOM_UNDER_ARBEID',
  RISIKOEIER_HAR_GODKJENT_ETTERLEVER_HAR_IKKE_ENDRET_SIDEN = 'RISIKOEIER_HAR_GODKJENT_ETTERLEVER_HAR_IKKE_ENDRET_SIDEN',
  ETTERLEVER_HAR_BEGYNT_MED_NYE_ENDRINGER_TELLES_SOM_UNDER_ARBEID = 'ETTERLEVER_HAR_BEGYNT_MED_NYE_ENDRINGER_TELLES_SOM_UNDER_ARBEID',
  ETTERLEVER_HAR_SENDT_OPPDATERT_PVK_DIREKTE_TIL_RISIKOEIER_TELLES_SOM_UNDER_ARBEID = 'ETTERLEVER_HAR_SENDT_OPPDATERT_PVK_DIREKTE_TIL_RISIKOEIER_TELLES_SOM_UNDER_ARBEID',
}
