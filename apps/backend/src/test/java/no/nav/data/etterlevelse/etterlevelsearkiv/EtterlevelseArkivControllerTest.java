...
class EtterlevelseArkivControllerTest extends IntegrationTestBase {
    ...
    void getEtterlevelseArkiv() {
        var etterlevelseArkiv = storageService.save(EtterlevelseArkiv.builder().build());
    ...
    void getByBehandlingsId_createTwoEtterlevelseArkiv_getOne(){
        storageService.save(EtterlevelseArkiv.builder().behandlingId("123").build());
    ...
    private void assertFields(EtterlevelseArkivResponse etterlevelseArkiv) {
        ...
        assertThat(etterlevelseArkiv.getStatus()).isEqualTo(EtterlevelseArkivStatus.TIL_ARKIVERING);
