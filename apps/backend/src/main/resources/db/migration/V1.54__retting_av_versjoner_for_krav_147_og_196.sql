ALTER TABLE ETTERLEVELSE_METADATA DISABLE TRIGGER ALL;
ALTER TABLE TILBAKEMELDING DISABLE TRIGGER ALL;
-- Krav 147 --
...
ALTER TABLE ETTERLEVELSE_METADATA ENABLE TRIGGER ALL;
ALTER TABLE TILBAKEMELDING ENABLE TRIGGER ALL;