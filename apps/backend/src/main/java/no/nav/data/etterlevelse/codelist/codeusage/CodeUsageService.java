...
public class CodeUsageService {
    ...
    public CodeUsageService(KravRepo kravRepo,EtterlevelseDokumentasjonRepoImpl customEtterlevelseDokumentasjonRepo, VirkemiddelRepo virkemiddelRepo, @Lazy CodelistService codelistService) {
        this.kravRepo = kravRepo;
        this.customEtterlevelseDokumentasjonRepo = customEtterlevelseDokumentasjonRepo;
    ...
    private List<EtterlevelseDokumentasjon> findEtterlevelseDokumentasjoner(ListName listName, String code) {
        return switch (listName) {
            case RELEVANS -> customEtterlevelseDokumentasjonRepo.findByIrrelevans(List.of(code));
