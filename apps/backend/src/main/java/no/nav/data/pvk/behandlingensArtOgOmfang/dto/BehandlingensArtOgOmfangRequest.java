...
public class BehandlingensArtOgOmfangRequest implements RequestElement {
    ...
    public void validateFieldValues(Validator<?> validator) {
        validator.checkNull(Fields.etterlevelseDokumentasjonId, etterlevelseDokumentasjonId);
    ...
    public void mergeInto(BehandlingensArtOgOmfang behandlingensArtOgOmfangToMerge) {
        behandlingensArtOgOmfangToMerge.setEtterlevelseDokumentasjonId(etterlevelseDokumentasjonId);
