...
public class EtterlevelseStudentResponse {
    private UUID id;
    ...
    public static EtterlevelseStudentResponse buildFrom(Etterlevelse etterlevelse) {
        return EtterlevelseStudentResponse.builder()
