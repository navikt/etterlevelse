...
public class EtterlevelseDokumentasjonService {
    ...
    public List<EtterlevelseDokumentasjon> getEtterlevelseDokumentasjonerWithSystem() {
        return etterlevelseDokumentasjonRepo.getEtterlevelseDokumentasjonWithSystem();
    }
