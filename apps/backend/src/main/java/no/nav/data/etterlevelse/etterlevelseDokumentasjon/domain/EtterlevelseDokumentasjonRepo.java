...
public interface EtterlevelseDokumentasjonRepo  extends JpaRepository<GenericStorage, UUID>, EtterlevelseDokumentasjonRepoCustom {
    ...
    @Query(value = "select * from generic_storage where data -> 'teams' ??| array['39a510e6-29d6-4f37-902c-dbfddfaafc0a'] and type = 'EtterlevelseDokumentasjon'", nativeQuery = true)
