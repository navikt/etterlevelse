...
public interface EtterlevelseDokumentasjonRepo extends JpaRepository<EtterlevelseDokumentasjon, UUID>, EtterlevelseDokumentasjonRepoCustom {
    ...
    @Override
    @Query(value = "select * from etterlevelse_dokumentasjon",
            countQuery = "select count(1) from etterlevelse_dokumentasjon",
            nativeQuery = true)
    Page<EtterlevelseDokumentasjon> findAll(Pageable pageable);
