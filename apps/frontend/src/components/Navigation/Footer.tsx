...
export const Footer = () => {
  return (
    <Block width='100%'>
      <Block position='fixed' display='flex' width='calc(100% - 80px)' justifyContent='flex-end' $style={{ cursor: 'pointer', top: '-50px' }} onClick={() => window.scrollTo(0, 0)} paddingRight='40px' paddingLeft='40px'>
        <img src={ToTopCircle} alt='Til toppen av siden' />
      </Block>
      <Block width='calc(100% - 80px)' height='100px' backgroundColor='#112724' paddingRight='40px' paddingLeft='40px'>
        <Block display='flex'
