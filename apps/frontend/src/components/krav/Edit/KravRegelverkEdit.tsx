...
export const KravRegelverkEdit = () => {
  ...
  const regelverkObject = () => ({
    lov: codelist.getCode(ListName.LOV, lov[0].id as string)!,
    spesifisering: text,
  })
              ...
              <Block>
                <Block>
                  <Block display="flex" alignItems={'flex-end'}>
                    ...
                    <Block width="100%">
                      <LabelWithTooltip
                        label={'Paragraf eller kapittel i regelverk'}
                        tooltip={'Beskrivelse'}
                      />
                      <CustomizedInput
                        value={text}
                        ...
                        placeholder={
                          'Beskrivelse, paragraf eller kapittel i regelverk'
                        }
                      />
                    </Block>
                  ...
                  {!!lov.length && text && (
                    ...
                    >
                      <LabelSmall marginRight={theme.sizing.scale800}>
                        Forhåndsvisning:{' '}
                      </LabelSmall>
