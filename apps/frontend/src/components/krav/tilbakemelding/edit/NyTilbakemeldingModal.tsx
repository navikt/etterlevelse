                          ...
                          <Block>
                            <Block display="flex" flexDirection="column" marginTop={theme.sizing.scale600}>
                              ...
                              {adresseType !== AdresseType.SLACK && !values.varslingsadresse && (
                                <Button kind="secondary"  type="button" icon={<FontAwesomeIcon icon={faSlackHash} />} onClick={() => setAdresseType(AdresseType.SLACK)}>
                                  Slack-kanal
                                </Button>
                              )}
                              ...
                              {adresseType !== AdresseType.SLACK_USER && !values.varslingsadresse && (
                                <Button kind="secondary"  marginLeft type="button" icon={<PersonIcon/>} onClick={() => setAdresseType(AdresseType.SLACK_USER)}>
                                  Slack-bruker
                                </Button>
                              )}
                              <Block marginTop={theme.sizing.scale400} />
                              ...
                              {adresseType !== AdresseType.EPOST && !values.varslingsadresse && (
                                <Button kind="secondary"  marginLeft type="button" icon={<EnvelopeClosedIcon/>} onClick={() => setAdresseType(AdresseType.EPOST)}>
                                  Epost
                                </Button>
                              )}
                            </Block>
