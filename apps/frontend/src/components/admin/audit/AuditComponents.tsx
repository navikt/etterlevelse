...
export const AuditActionIcon = (props: { action: EAuditAction; withText?: boolean }) => {
  const icon = (props.action === EAuditAction.CREATE && <PlusCircleIcon area-label="" aria-hidden color="#007C2E" />) ||
    (props.action === EAuditAction.UPDATE && <InformationSquareIcon area-label="" aria-hidden color="#C77300" />) ||
    (props.action === EAuditAction.DELETE && <MinusCircleIcon area-label="" aria-hidden color="#C30000" />) || <div />
