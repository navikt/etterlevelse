...
export const AuditButton = (props: { id: string; fontColor?: string; auditId?: string; kind?: typeof KIND[keyof typeof KIND]; marginLeft?: boolean; marginRight?: boolean; children?: any }) => {
  return user.isAdmin() ? (
