            ...
            <>
              <Block {...rowBlockProps}>
                ...
                <CustomizedInput
                  ...
                  value={data.lovId}
                  onChange={str =>
                    set({lovId: (str.target as HTMLInputElement).value})
                  }
                />
              </Block>
              ...
              <Block {...rowBlockProps}>
                ...
                <OptionList
                  ...
                  value={
                    codelist.getCode(ListName.TEMA, data.tema) as
                      | Code
                      | undefined
                  }
            ...
            <>
              <Block {...rowBlockProps}>
                <Label2 marginRight={'1rem'} width="25%">
                  Bilde:
                  <StatefulTooltip
                    content={<PreviewImages set={image => set({image})} />}
                  >
