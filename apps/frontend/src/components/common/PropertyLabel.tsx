...
type LabelProps = {
  ...
  {markdown: string | string[]; vertical?: boolean}
>

export const Label = (props: LabelProps) => {
  if (props.hide || (empty(props.children) && empty(props.markdown)))
    return null
  return (
      ...
      {props.markdown ? (
        <Block marginTop={'-1rem'} marginBottom={'-1rem'}>
          <Markdown
            p1={props.p1}
            sources={
              Array.isArray(props.markdown) ? props.markdown : [props.markdown]
            }
