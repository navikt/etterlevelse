...
import {
  Code,
  codelistCompareField,
  codelistsCompareField,
    ...
    <Table
      ...
      config={{
        ...
        sorting: {
          ...
          regelverk: codelistsCompareField<KravQL>(
            k => k.regelverk.map(r => r.lov as Code),
            variables?.lov,
          ),
        },
        exclude: props.exclude,
      ...
      renderRow={krav => [
        ...
        <Cell>
          <RouteLink href={`/krav/${krav.kravNummer}/${krav.kravVersjon}`}>
            {krav.navn}
          </RouteLink>
        </Cell>,
