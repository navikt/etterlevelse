...
export const Chart = (props: ChartProps) => {
  ...
  const colorsBase = ['#a6cee3', '#1f78b4', '#b2df8a', '#33a02c', '#fb9a99', '#e31a1c', '#fdbf6f', '#ff7f00', '#cab2d6', '#6a3d9a', '#ffff99', '#b15928']
              ...
              {data.map((d, idx) => (
                <div key={idx} onMouseOver={() => setHover(idx)} onClick={d.onClick}>
                  <Block backgroundColor={idx === hover ? theme.colors.accent50 : theme.colors.white} $style={cursor} display="flex" alignItems="center">
                    ...
                    <Block minWidth={theme.sizing.scale1200} display="flex" justifyContent="flex-end">
