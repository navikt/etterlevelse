...
const BehandlingSok = () => {
  ...
  const {
    ...
    variables: { behandlingId: behandlingUUID ? behandlingUUID : 'test' },
    skip: tooShort,
  })
  const etterlevelseDokumentasjoner = data?.etterlevelseDokumentasjoner || emptyPage
  const loading = !data && gqlLoading
...
type Variables = { pageNumber?: number; pageSize?: number; sistRedigert?: number; mineEtterlevelseDokumentasjoner?: boolean; sok?: string; teams?: string[]; behandlingId?: string }
