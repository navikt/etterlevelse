        ...
        <Wide>
          <Block display={'flex'} justifyContent={'space-evenly'} flexWrap>
            <PanelLinkCard
              ...
              icon={paperPenIconBg}
              beskrivelse={
                'Få oversikt over hvilke krav som gjelder din løsning og dokumenter hvor godt løsningen etterlever kravene.'
              }
            />
            ...
            <PanelLinkCard
              ...
              icon={grafIconBg}
              beskrivelse={
                'Følg med på status i dashbord, lag egne oversikter, og se hvor godt NAV sine produktområder  dokumenterer på kravene'
              }
            />
            ...
            <PanelLinkCard
              ...
              icon={paragrafIconBg}
              beskrivelse={
                'Få oversikt over kravene, og bli trygg på at du kjenner til alle relevante krav for det du lager'
              }
            />
          </Block>
        </Wide>
          ...
          >
            ...
            <Block>
              ...
              <ParagraphMedium>
                ...
                venenatis, a mattis ut tempor, proin aliquam aenean. Nec amet
                tincidunt ut odio habitant vel blandit et id. At in sed enim
                cursus nisi. A fermentum pellentesque nulla lacus viverra a,
                ultrices.
              </ParagraphMedium>
            </Block>
          </Block>
