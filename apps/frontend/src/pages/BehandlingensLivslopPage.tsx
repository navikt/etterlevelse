import { Alert, BodyShort, Heading, Label, Link, List, Loader, ReadMore } from '@navikt/ds-react'
            ...
            <div className="pr-4 flex flex-1 flex-col gap-4 col-span-8">
              <BodyShort>
                ...
                <Alert inline variant="info" className="mt-3">
                  Det er kun påkrevd å tegne behandlingens livsløp hvis dere gjennomfører en PVK,
                  men vi anbefaler at alle tegner flyten. Dette vil være til hjelp når dere svarer
                  ut etterlevelseskrav innen Personvern og Arkiv og dokumentasjon.
                </Alert>
              </BodyShort>
              ...
              <BodyShort className="mt-3">
                ...
                Detaljnivået vil variere, men intensjonen er at dere viser [PVO må gjerne supplere
                her]
              </BodyShort>
